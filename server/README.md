...
The 2,000,000 entry baseline is an Exoware ingest contract. Any sequence-row
cap is not imposed by the Exoware server. A cap imposed downstream by a store
