...
export type RangeFrame = Message<"store.query.v1.RangeFrame"> & {
  /**
   * @generated from field: repeated common.kv.v1.KvEntry results = 1;
   */
  results: KvEntry[];
