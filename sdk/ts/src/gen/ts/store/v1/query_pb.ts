...
export type RangeFrame = Message<"store.query.v1.RangeFrame"> & {
  /**
   * @generated from field: repeated common.v1.KvEntry results = 1;
   */
  results: KvEntry[];
