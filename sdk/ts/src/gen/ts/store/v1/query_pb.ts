...
import type { KvEntry } from "../../log/v1/common_pb.js";
...
export type RangeFrame = Message<"store.query.v1.RangeFrame"> & {
  /**
   * @generated from field: repeated log.common.v1.KvEntry results = 1;
   */
  results: KvEntry[];
