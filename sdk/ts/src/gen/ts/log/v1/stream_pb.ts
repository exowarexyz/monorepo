...
import { file_log_v1_common } from "./common_pb.js";
...
export const file_log_v1_stream: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_log_v1_common]);
...
export type SubscribeRequest = Message<"log.stream.v1.SubscribeRequest"> & {
   ...
   *
   * @generated from field: repeated log.common.v1.MatchKey match_keys = 1;
   */
  matchKeys: MatchKey[];
...
export type SubscribeResponse = Message<"log.stream.v1.SubscribeResponse"> & {
  ...
  /**
   * @generated from field: repeated log.common.v1.KvEntry entries = 2;
   */
  entries: KvEntry[];
};
