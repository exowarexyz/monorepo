...
import { SimplexClient, SimplexRecordKind, createCommonwareSimplexVerifier, createWasmSimplexVerifier, blockByDigestKey, bytesToHex, finalizationByViewKey, finalizedByHeightKey, hexToBytes, notarizationByViewKey, rangeForKind, } from '../src/index.js';
...
test('stages block and finalization rows into one StoreWriteBatch', () => {
    ...
    assert.deepEqual(batch.entries().map((entry) => bytesToHex(entry.key)), ['0010d0', '00300000000000000007', '0031000000000000000b']);
});
