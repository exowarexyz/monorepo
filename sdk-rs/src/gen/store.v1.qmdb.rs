...
impl ::core::fmt::Debug for RangeSubscribeRequest {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("RangeSubscribeRequest")
            .field("since_sequence_number", &self.since_sequence_number)
            .finish()
    }
}
impl RangeSubscribeRequest {
    ...
    ///
    /// Format: `type.googleapis.com/<fully.qualified.TypeName>`
    pub const TYPE_URL: &'static str = "type.googleapis.com/store.qmdb.v1.RangeSubscribeRequest";
}
unsafe impl ::buffa::DefaultInstance for RangeSubscribeRequest {
    fn default_instance() -> &'static Self {
        static VALUE: ::buffa::__private::OnceBox<RangeSubscribeRequest> = ::buffa::__private::OnceBox::new();
        VALUE.get_or_init(|| ::buffa::alloc::boxed::Box::new(Self::default()))
    }
}
impl ::buffa::Message for RangeSubscribeRequest {
    /// Returns the total encoded size in bytes.
    ///
    /// The result is a `u32`; the protobuf specification requires all
    /// messages to fit within 2 GiB (2,147,483,647 bytes), so a
...
impl ::buffa::ExtensionSet for RangeSubscribeRequest {
    const PROTO_FQN: &'static str = "store.qmdb.v1.RangeSubscribeRequest";
    fn unknown_fields(&self) -> &::buffa::UnknownFields {
        &self.__buffa_unknown_fields
    }
    fn unknown_fields_mut(&mut self) -> &mut ::buffa::UnknownFields {
...
impl ::buffa::json_helpers::ProtoElemJson for RangeSubscribeRequest {
    fn serialize_proto_json<S: ::serde::Serializer>(
        v: &Self,
        s: S,
    ) -> ::core::result::Result<S::Ok, S::Error> {
...
#[doc(hidden)]
pub const __RANGE_SUBSCRIBE_REQUEST_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/store.qmdb.v1.RangeSubscribeRequest",
    to_json: ::buffa::type_registry::any_to_json::<RangeSubscribeRequest>,
    from_json: ::buffa::type_registry::any_from_json::<RangeSubscribeRequest>,
    is_wkt: false,
};
/// Subscribe to published batch checkpoints for a QMDB backend.
#[derive(Clone, Debug, Default)]
pub struct RangeSubscribeRequestView<'a> {
    /// Resume cursor over the underlying store batch log. Use
    /// `RangeSubscribeResponse.resume_sequence_number + 1` to resume after a
    /// disconnect.
    ///
...
impl<'a> RangeSubscribeRequestView<'a> {
    /// Decode from `buf`, enforcing a recursion depth limit for nested messages.
    ///
    /// Called by [`::buffa::MessageView::decode_view`] with [`::buffa::RECURSION_LIMIT`]
    /// and by generated sub-message decode arms with `depth - 1`.
...
impl<'a> ::buffa::MessageView<'a> for RangeSubscribeRequestView<'a> {
    type Owned = RangeSubscribeRequest;
    fn decode_view(buf: &'a [u8]) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        Self::_decode_depth(buf, ::buffa::RECURSION_LIMIT)
    }
    fn decode_view_with_limit(
    ...
    /// Convert this view to the owned message type.
    #[allow(clippy::redundant_closure, clippy::useless_conversion)]
    fn to_owned_message(&self) -> RangeSubscribeRequest {
        #[allow(unused_imports)]
        use ::buffa::alloc::string::ToString as _;
...
unsafe impl ::buffa::DefaultViewInstance for RangeSubscribeRequestView<'static> {
    fn default_view_instance() -> &'static Self {
        static VALUE: ::buffa::__private::OnceBox<RangeSubscribeRequestView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE.get_or_init(|| ::buffa::alloc::boxed::Box::new(Self::default()))
    }
}
unsafe impl<'a> ::buffa::HasDefaultViewInstance for RangeSubscribeRequestView<'a> {
    type Static = RangeSubscribeRequestView<'static>;
}
...
impl HistoricalRangeProof {
    /// Protobuf type URL for this message, for use with `Any::pack` and
    /// `Any::unpack_if`.
    ///
    /// Format: `type.googleapis.com/<fully.qualified.TypeName>`
    pub const TYPE_URL: &'static str = "type.googleapis.com/store.qmdb.v1.HistoricalRangeProof";
}
unsafe impl ::buffa::DefaultInstance for HistoricalRangeProof {
    fn default_instance() -> &'static Self {
        static VALUE: ::buffa::__private::OnceBox<HistoricalRangeProof> = ::buffa::__private::OnceBox::new();
        VALUE.get_or_init(|| ::buffa::alloc::boxed::Box::new(Self::default()))
    }
}
impl ::buffa::Message for HistoricalRangeProof {
    /// Returns the total encoded size in bytes.
    ///
    /// The result is a `u32`; the protobuf specification requires all
    /// messages to fit within 2 GiB (2,147,483,647 bytes), so a
...
impl ::buffa::ExtensionSet for HistoricalRangeProof {
    const PROTO_FQN: &'static str = "store.qmdb.v1.HistoricalRangeProof";
    fn unknown_fields(&self) -> &::buffa::UnknownFields {
        &self.__buffa_unknown_fields
    }
    fn unknown_fields_mut(&mut self) -> &mut ::buffa::UnknownFields {
...
impl ::buffa::json_helpers::ProtoElemJson for HistoricalRangeProof {
    fn serialize_proto_json<S: ::serde::Serializer>(
        v: &Self,
        s: S,
    ) -> ::core::result::Result<S::Ok, S::Error> {
...
#[doc(hidden)]
pub const __HISTORICAL_RANGE_PROOF_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/store.qmdb.v1.HistoricalRangeProof",
    to_json: ::buffa::type_registry::any_to_json::<HistoricalRangeProof>,
    from_json: ::buffa::type_registry::any_from_json::<HistoricalRangeProof>,
    is_wkt: false,
};
/// Historical contiguous range proof over one published batch.
#[derive(Clone, Debug, Default)]
...
impl<'a> HistoricalRangeProofView<'a> {
    /// Decode from `buf`, enforcing a recursion depth limit for nested messages.
    ///
    /// Called by [`::buffa::MessageView::decode_view`] with [`::buffa::RECURSION_LIMIT`]
    /// and by generated sub-message decode arms with `depth - 1`.
...
impl<'a> ::buffa::MessageView<'a> for HistoricalRangeProofView<'a> {
    type Owned = HistoricalRangeProof;
    fn decode_view(buf: &'a [u8]) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        Self::_decode_depth(buf, ::buffa::RECURSION_LIMIT)
    }
    fn decode_view_with_limit(
    ...
    /// Convert this view to the owned message type.
    #[allow(clippy::redundant_closure, clippy::useless_conversion)]
    fn to_owned_message(&self) -> HistoricalRangeProof {
        #[allow(unused_imports)]
        use ::buffa::alloc::string::ToString as _;
...
unsafe impl ::buffa::DefaultViewInstance for HistoricalRangeProofView<'static> {
    fn default_view_instance() -> &'static Self {
        static VALUE: ::buffa::__private::OnceBox<HistoricalRangeProofView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE.get_or_init(|| ::buffa::alloc::boxed::Box::new(Self::default()))
    }
}
unsafe impl<'a> ::buffa::HasDefaultViewInstance for HistoricalRangeProofView<'a> {
    type Static = HistoricalRangeProofView<'static>;
}
...
#[derive(::serde::Serialize, ::serde::Deserialize)]
#[serde(default)]
pub struct RangeSubscribeResponse {
    /// Underlying store stream sequence that made this proof readable end-to-end.
    ///
    /// Field 1: `resume_sequence_number`
    #[serde(
    ...
    pub proof: ::buffa::MessageField<HistoricalRangeProof>,
    #[serde(skip)]
    #[doc(hidden)]
    pub __buffa_unknown_fields: ::buffa::UnknownFields,
    #[doc(hidden)]
...
impl ::core::fmt::Debug for RangeSubscribeResponse {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("RangeSubscribeResponse")
            .field("resume_sequence_number", &self.resume_sequence_number)
            .field("proof", &self.proof)
            .finish()
    }
}
impl RangeSubscribeResponse {
    /// Protobuf type URL for this message, for use with `Any::pack` and
    /// `Any::unpack_if`.
    ///
    /// Format: `type.googleapis.com/<fully.qualified.TypeName>`
    pub const TYPE_URL: &'static str = "type.googleapis.com/store.qmdb.v1.RangeSubscribeResponse";
}
unsafe impl ::buffa::DefaultInstance for RangeSubscribeResponse {
    fn default_instance() -> &'static Self {
        static VALUE: ::buffa::__private::OnceBox<RangeSubscribeResponse> = ::buffa::__private::OnceBox::new();
        VALUE.get_or_init(|| ::buffa::alloc::boxed::Box::new(Self::default()))
    }
}
impl ::buffa::Message for RangeSubscribeResponse {
    /// Returns the total encoded size in bytes.
    ///
    /// The result is a `u32`; the protobuf specification requires all
    /// messages to fit within 2 GiB (2,147,483,647 bytes), so a
...
impl ::buffa::ExtensionSet for RangeSubscribeResponse {
    const PROTO_FQN: &'static str = "store.qmdb.v1.RangeSubscribeResponse";
    fn unknown_fields(&self) -> &::buffa::UnknownFields {
        &self.__buffa_unknown_fields
    }
    fn unknown_fields_mut(&mut self) -> &mut ::buffa::UnknownFields {
...
impl ::buffa::json_helpers::ProtoElemJson for RangeSubscribeResponse {
    fn serialize_proto_json<S: ::serde::Serializer>(
        v: &Self,
        s: S,
    ) -> ::core::result::Result<S::Ok, S::Error> {
...
#[doc(hidden)]
pub const __RANGE_SUBSCRIBE_RESPONSE_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/store.qmdb.v1.RangeSubscribeResponse",
    to_json: ::buffa::type_registry::any_to_json::<RangeSubscribeResponse>,
    from_json: ::buffa::type_registry::any_from_json::<RangeSubscribeResponse>,
    is_wkt: false,
};
/// One emitted range checkpoint for a subscribed batch.
#[derive(Clone, Debug, Default)]
pub struct RangeSubscribeResponseView<'a> {
    /// Underlying store stream sequence that made this proof readable end-to-end.
    ///
    /// Field 1: `resume_sequence_number`
    pub resume_sequence_number: u64,
    /// Field 2: `proof`
    pub proof: ::buffa::MessageFieldView<HistoricalRangeProofView<'a>>,
    pub __buffa_unknown_fields: ::buffa::UnknownFieldsView<'a>,
}
impl<'a> RangeSubscribeResponseView<'a> {
    /// Decode from `buf`, enforcing a recursion depth limit for nested messages.
    ///
    /// Called by [`::buffa::MessageView::decode_view`] with [`::buffa::RECURSION_LIMIT`]
    /// and by generated sub-message decode arms with `depth - 1`.
            ...
            match tag.field_number() {
                ...
                2u32 => {
                    ...
                    match view.proof.as_mut() {
                        ...
                        None => {
                            view.proof = ::buffa::MessageFieldView::set(
                                HistoricalRangeProofView::_decode_depth(sub, depth - 1)?,
                            );
                        }
                    }
                }
...
impl<'a> ::buffa::MessageView<'a> for RangeSubscribeResponseView<'a> {
    type Owned = RangeSubscribeResponse;
    fn decode_view(buf: &'a [u8]) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        Self::_decode_depth(buf, ::buffa::RECURSION_LIMIT)
    }
    fn decode_view_with_limit(
    ...
    /// Convert this view to the owned message type.
    #[allow(clippy::redundant_closure, clippy::useless_conversion)]
    fn to_owned_message(&self) -> RangeSubscribeResponse {
        #[allow(unused_imports)]
        use ::buffa::alloc::string::ToString as _;
...
unsafe impl ::buffa::DefaultViewInstance for RangeSubscribeResponseView<'static> {
    fn default_view_instance() -> &'static Self {
        static VALUE: ::buffa::__private::OnceBox<RangeSubscribeResponseView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE.get_or_init(|| ::buffa::alloc::boxed::Box::new(Self::default()))
    }
}
unsafe impl<'a> ::buffa::HasDefaultViewInstance for RangeSubscribeResponseView<'a> {
    type Static = RangeSubscribeResponseView<'static>;
}
    ...
    <T::ResponseBody as ::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the Subscribe RPC. Sends a request to /store.qmdb.v1.OrderedService/Subscribe.
...
/// Full service name for this service.
pub const ORDERED_RANGE_SERVICE_SERVICE_NAME: &str = "store.qmdb.v1.OrderedRangeService";
...
/// for zero-copy access patterns and when `to_owned_message()` is needed.
#[allow(clippy::type_complexity)]
pub trait OrderedRangeService: Send + Sync + 'static {
    /// Handle the Subscribe RPC.
    fn subscribe(
        &self,
        ctx: ::connectrpc::Context,
...
/// let router = service.register(Router::new());
/// ```
pub trait OrderedRangeServiceExt: OrderedRangeService {
    /// Register this service implementation with a Router.
    ///
    /// Takes ownership of the `Arc<Self>` and returns a new Router with
    /// this service's methods registered.
...
impl<S: OrderedRangeService> OrderedRangeServiceExt for S {
    fn register(
        self: ::std::sync::Arc<Self>,
        router: ::connectrpc::Router,
    ) -> ::connectrpc::Router {
        router
            .route_view_server_stream(
                ORDERED_RANGE_SERVICE_SERVICE_NAME,
                "Subscribe",
                ::connectrpc::view_streaming_handler_fn({
                    let svc = ::std::sync::Arc::clone(&self);
                    move |ctx, req| {
...
/// Monomorphic dispatcher for `OrderedRangeService`.
///
/// Unlike `.register(Router)` which type-erases each method into an `Arc<dyn ErasedHandler>` stored in a `HashMap`, this struct dispatches via a compile-time `match` on method name: no vtable, no hash lookup.
///
/// # Example
...
/// use connectrpc::ConnectRpcService;
///
/// let server = OrderedRangeServiceServer::new(MyImpl);
/// let service = ConnectRpcService::new(server);
/// // hand `service` to axum/hyper as a fallback_service
/// ```
pub struct OrderedRangeServiceServer<T> {
    inner: ::std::sync::Arc<T>,
}
impl<T: OrderedRangeService> OrderedRangeServiceServer<T> {
    /// Wrap a service implementation in a monomorphic dispatcher.
    pub fn new(service: T) -> Self {
        Self {
            inner: ::std::sync::Arc::new(service),
...
impl<T> Clone for OrderedRangeServiceServer<T> {
    fn clone(&self) -> Self {
        Self {
            inner: ::std::sync::Arc::clone(&self.inner),
        }
...
impl<T: OrderedRangeService> ::connectrpc::Dispatcher for OrderedRangeServiceServer<T> {
    #[inline]
    fn lookup(
        &self,
        path: &str,
    ) -> Option<::connectrpc::dispatcher::codegen::MethodDescriptor> {
        let method = path.strip_prefix("store.qmdb.v1.OrderedRangeService/")?;
        match method {
            "Subscribe" => {
                Some(
                    ::connectrpc::dispatcher::codegen::MethodDescriptor::server_streaming(),
    ...
    fn call_unary(
        ...
        let Some(method) = path.strip_prefix("store.qmdb.v1.OrderedRangeService/") else {
            return ::connectrpc::dispatcher::codegen::unimplemented_unary(path);
        };
        let _ = (&ctx, &request, &format);
        match method {
...
/// let config = ClientConfig::new(uri).protocol(Protocol::Grpc);
///
/// let client = OrderedRangeServiceClient::new(conn, config);
/// let response = client.subscribe(request).await?;
/// ```
///
/// # Example (Connect / HTTP/1.1 or ALPN)
...
/// let config = ClientConfig::new("http://localhost:8080".parse()?);
///
/// let client = OrderedRangeServiceClient::new(http, config);
/// let response = client.subscribe(request).await?;
/// ```
///
/// # Working with the response
...
/// ```
#[derive(Clone)]
pub struct OrderedRangeServiceClient<T> {
    transport: T,
    config: ::connectrpc::client::ClientConfig,
}
impl<T> OrderedRangeServiceClient<T>
where
    T: ::connectrpc::client::ClientTransport,
    <T::ResponseBody as ::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the Subscribe RPC. Sends a request to /store.qmdb.v1.OrderedRangeService/Subscribe.
    pub async fn subscribe(
        &self,
        ...
        ::connectrpc::client::ServerStream<
            T::ResponseBody,
            RangeSubscribeResponseView<'static>,
        >,
        ::connectrpc::ConnectError,
    > {
        self.subscribe_with_options(
...
/// Full service name for this service.
pub const UNORDERED_RANGE_SERVICE_SERVICE_NAME: &str = "store.qmdb.v1.UnorderedRangeService";
...
/// for zero-copy access patterns and when `to_owned_message()` is needed.
#[allow(clippy::type_complexity)]
pub trait UnorderedRangeService: Send + Sync + 'static {
    /// Handle the Subscribe RPC.
    fn subscribe(
        &self,
        ctx: ::connectrpc::Context,
...
/// let router = service.register(Router::new());
/// ```
pub trait UnorderedRangeServiceExt: UnorderedRangeService {
    /// Register this service implementation with a Router.
    ///
    /// Takes ownership of the `Arc<Self>` and returns a new Router with
    /// this service's methods registered.
...
impl<S: UnorderedRangeService> UnorderedRangeServiceExt for S {
    fn register(
        self: ::std::sync::Arc<Self>,
        router: ::connectrpc::Router,
    ) -> ::connectrpc::Router {
        router
            .route_view_server_stream(
                UNORDERED_RANGE_SERVICE_SERVICE_NAME,
                "Subscribe",
                ::connectrpc::view_streaming_handler_fn({
                    let svc = ::std::sync::Arc::clone(&self);
                    move |ctx, req| {
...
/// Monomorphic dispatcher for `UnorderedRangeService`.
///
/// Unlike `.register(Router)` which type-erases each method into an `Arc<dyn ErasedHandler>` stored in a `HashMap`, this struct dispatches via a compile-time `match` on method name: no vtable, no hash lookup.
///
/// # Example
...
/// use connectrpc::ConnectRpcService;
///
/// let server = UnorderedRangeServiceServer::new(MyImpl);
/// let service = ConnectRpcService::new(server);
/// // hand `service` to axum/hyper as a fallback_service
/// ```
pub struct UnorderedRangeServiceServer<T> {
    inner: ::std::sync::Arc<T>,
}
impl<T: UnorderedRangeService> UnorderedRangeServiceServer<T> {
    /// Wrap a service implementation in a monomorphic dispatcher.
    pub fn new(service: T) -> Self {
        Self {
            inner: ::std::sync::Arc::new(service),
...
impl<T> Clone for UnorderedRangeServiceServer<T> {
    fn clone(&self) -> Self {
        Self {
            inner: ::std::sync::Arc::clone(&self.inner),
        }
...
impl<T: UnorderedRangeService> ::connectrpc::Dispatcher
for UnorderedRangeServiceServer<T> {
    #[inline]
    fn lookup(
        &self,
        path: &str,
    ) -> Option<::connectrpc::dispatcher::codegen::MethodDescriptor> {
        let method = path.strip_prefix("store.qmdb.v1.UnorderedRangeService/")?;
        match method {
            "Subscribe" => {
                Some(
                    ::connectrpc::dispatcher::codegen::MethodDescriptor::server_streaming(),
    ...
    fn call_unary(
        ...
        let Some(method) = path.strip_prefix("store.qmdb.v1.UnorderedRangeService/")
        else {
            return ::connectrpc::dispatcher::codegen::unimplemented_unary(path);
        };
        let _ = (&ctx, &request, &format);
...
/// let config = ClientConfig::new(uri).protocol(Protocol::Grpc);
///
/// let client = UnorderedRangeServiceClient::new(conn, config);
/// let response = client.subscribe(request).await?;
/// ```
///
/// # Example (Connect / HTTP/1.1 or ALPN)
...
/// let config = ClientConfig::new("http://localhost:8080".parse()?);
///
/// let client = UnorderedRangeServiceClient::new(http, config);
/// let response = client.subscribe(request).await?;
/// ```
///
/// # Working with the response
...
/// ```
#[derive(Clone)]
pub struct UnorderedRangeServiceClient<T> {
    transport: T,
    config: ::connectrpc::client::ClientConfig,
}
impl<T> UnorderedRangeServiceClient<T>
where
    T: ::connectrpc::client::ClientTransport,
    <T::ResponseBody as ::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the Subscribe RPC. Sends a request to /store.qmdb.v1.UnorderedRangeService/Subscribe.
    pub async fn subscribe(
        &self,
        request: RangeSubscribeRequest,
    ) -> Result<
...
/// Full service name for this service.
pub const IMMUTABLE_RANGE_SERVICE_SERVICE_NAME: &str = "store.qmdb.v1.ImmutableRangeService";
...
/// for zero-copy access patterns and when `to_owned_message()` is needed.
#[allow(clippy::type_complexity)]
pub trait ImmutableRangeService: Send + Sync + 'static {
    /// Handle the Subscribe RPC.
    fn subscribe(
        &self,
        ctx: ::connectrpc::Context,
...
/// let router = service.register(Router::new());
/// ```
pub trait ImmutableRangeServiceExt: ImmutableRangeService {
    /// Register this service implementation with a Router.
    ///
    /// Takes ownership of the `Arc<Self>` and returns a new Router with
    /// this service's methods registered.
...
impl<S: ImmutableRangeService> ImmutableRangeServiceExt for S {
    fn register(
        self: ::std::sync::Arc<Self>,
        router: ::connectrpc::Router,
    ) -> ::connectrpc::Router {
        router
            .route_view_server_stream(
                IMMUTABLE_RANGE_SERVICE_SERVICE_NAME,
                "Subscribe",
                ::connectrpc::view_streaming_handler_fn({
                    let svc = ::std::sync::Arc::clone(&self);
                    move |ctx, req| {
...
/// Monomorphic dispatcher for `ImmutableRangeService`.
///
/// Unlike `.register(Router)` which type-erases each method into an `Arc<dyn ErasedHandler>` stored in a `HashMap`, this struct dispatches via a compile-time `match` on method name: no vtable, no hash lookup.
///
/// # Example
...
/// use connectrpc::ConnectRpcService;
///
/// let server = ImmutableRangeServiceServer::new(MyImpl);
/// let service = ConnectRpcService::new(server);
/// // hand `service` to axum/hyper as a fallback_service
/// ```
pub struct ImmutableRangeServiceServer<T> {
    inner: ::std::sync::Arc<T>,
}
impl<T: ImmutableRangeService> ImmutableRangeServiceServer<T> {
    /// Wrap a service implementation in a monomorphic dispatcher.
    pub fn new(service: T) -> Self {
        Self {
            inner: ::std::sync::Arc::new(service),
...
impl<T> Clone for ImmutableRangeServiceServer<T> {
    fn clone(&self) -> Self {
        Self {
            inner: ::std::sync::Arc::clone(&self.inner),
        }
...
impl<T: ImmutableRangeService> ::connectrpc::Dispatcher
for ImmutableRangeServiceServer<T> {
    #[inline]
    fn lookup(
        &self,
        path: &str,
    ) -> Option<::connectrpc::dispatcher::codegen::MethodDescriptor> {
        let method = path.strip_prefix("store.qmdb.v1.ImmutableRangeService/")?;
        match method {
            "Subscribe" => {
                Some(
                    ::connectrpc::dispatcher::codegen::MethodDescriptor::server_streaming(),
    ...
    fn call_unary(
        ...
        let Some(method) = path.strip_prefix("store.qmdb.v1.ImmutableRangeService/")
        else {
            return ::connectrpc::dispatcher::codegen::unimplemented_unary(path);
        };
        let _ = (&ctx, &request, &format);
...
/// let config = ClientConfig::new(uri).protocol(Protocol::Grpc);
///
/// let client = ImmutableRangeServiceClient::new(conn, config);
/// let response = client.subscribe(request).await?;
/// ```
///
/// # Example (Connect / HTTP/1.1 or ALPN)
...
/// let config = ClientConfig::new("http://localhost:8080".parse()?);
///
/// let client = ImmutableRangeServiceClient::new(http, config);
/// let response = client.subscribe(request).await?;
/// ```
///
/// # Working with the response
...
/// ```
#[derive(Clone)]
pub struct ImmutableRangeServiceClient<T> {
    transport: T,
    config: ::connectrpc::client::ClientConfig,
}
impl<T> ImmutableRangeServiceClient<T>
where
    T: ::connectrpc::client::ClientTransport,
    <T::ResponseBody as ::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the Subscribe RPC. Sends a request to /store.qmdb.v1.ImmutableRangeService/Subscribe.
    pub async fn subscribe(
        &self,
        request: RangeSubscribeRequest,
    ) -> Result<
...
/// Full service name for this service.
pub const KEYLESS_RANGE_SERVICE_SERVICE_NAME: &str = "store.qmdb.v1.KeylessRangeService";
...
/// for zero-copy access patterns and when `to_owned_message()` is needed.
#[allow(clippy::type_complexity)]
pub trait KeylessRangeService: Send + Sync + 'static {
    /// Handle the Subscribe RPC.
    fn subscribe(
        &self,
        ctx: ::connectrpc::Context,
...
/// let router = service.register(Router::new());
/// ```
pub trait KeylessRangeServiceExt: KeylessRangeService {
    /// Register this service implementation with a Router.
    ///
    /// Takes ownership of the `Arc<Self>` and returns a new Router with
    /// this service's methods registered.
...
impl<S: KeylessRangeService> KeylessRangeServiceExt for S {
    fn register(
        self: ::std::sync::Arc<Self>,
        router: ::connectrpc::Router,
    ) -> ::connectrpc::Router {
        router
            .route_view_server_stream(
                KEYLESS_RANGE_SERVICE_SERVICE_NAME,
                "Subscribe",
                ::connectrpc::view_streaming_handler_fn({
                    let svc = ::std::sync::Arc::clone(&self);
                    move |ctx, req| {
...
/// Monomorphic dispatcher for `KeylessRangeService`.
///
/// Unlike `.register(Router)` which type-erases each method into an `Arc<dyn ErasedHandler>` stored in a `HashMap`, this struct dispatches via a compile-time `match` on method name: no vtable, no hash lookup.
///
/// # Example
...
/// use connectrpc::ConnectRpcService;
///
/// let server = KeylessRangeServiceServer::new(MyImpl);
/// let service = ConnectRpcService::new(server);
/// // hand `service` to axum/hyper as a fallback_service
/// ```
pub struct KeylessRangeServiceServer<T> {
    inner: ::std::sync::Arc<T>,
}
impl<T: KeylessRangeService> KeylessRangeServiceServer<T> {
    /// Wrap a service implementation in a monomorphic dispatcher.
    pub fn new(service: T) -> Self {
        Self {
            inner: ::std::sync::Arc::new(service),
...
impl<T> Clone for KeylessRangeServiceServer<T> {
    fn clone(&self) -> Self {
        Self {
            inner: ::std::sync::Arc::clone(&self.inner),
        }
...
impl<T: KeylessRangeService> ::connectrpc::Dispatcher for KeylessRangeServiceServer<T> {
    #[inline]
    fn lookup(
        &self,
        path: &str,
    ) -> Option<::connectrpc::dispatcher::codegen::MethodDescriptor> {
        let method = path.strip_prefix("store.qmdb.v1.KeylessRangeService/")?;
        match method {
            "Subscribe" => {
                Some(
                    ::connectrpc::dispatcher::codegen::MethodDescriptor::server_streaming(),
    ...
    fn call_unary(
        ...
        let Some(method) = path.strip_prefix("store.qmdb.v1.KeylessRangeService/") else {
            return ::connectrpc::dispatcher::codegen::unimplemented_unary(path);
        };
        let _ = (&ctx, &request, &format);
        match method {
...
/// let config = ClientConfig::new(uri).protocol(Protocol::Grpc);
///
/// let client = KeylessRangeServiceClient::new(conn, config);
/// let response = client.subscribe(request).await?;
/// ```
///
/// # Example (Connect / HTTP/1.1 or ALPN)
...
/// let config = ClientConfig::new("http://localhost:8080".parse()?);
///
/// let client = KeylessRangeServiceClient::new(http, config);
/// let response = client.subscribe(request).await?;
/// ```
///
/// # Working with the response
...
/// ```
#[derive(Clone)]
pub struct KeylessRangeServiceClient<T> {
    transport: T,
    config: ::connectrpc::client::ClientConfig,
}
impl<T> KeylessRangeServiceClient<T>
where
    T: ::connectrpc::client::ClientTransport,
    <T::ResponseBody as ::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the Subscribe RPC. Sends a request to /store.qmdb.v1.KeylessRangeService/Subscribe.
    pub async fn subscribe(
        &self,
        request: RangeSubscribeRequest,
    ) -> Result<
