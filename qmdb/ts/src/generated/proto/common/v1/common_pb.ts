...
export const file_common_v1_common: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate]);
 ...
 * used for ingestion.
 *
 * @generated from message common.v1.KvEntry
 */
export type KvEntry = Message<"common.v1.KvEntry"> & {
  /**
...
/**
 * Describes the message common.v1.KvEntry.
 ...
 *
 * @generated from message common.v1.MatchKey
 */
export type MatchKey = Message<"common.v1.MatchKey"> & {
  /**
...
/**
 * Describes the message common.v1.MatchKey.
 ...
 *
 * @generated from message common.v1.BytesFilter
 */
export type BytesFilter = Message<"common.v1.BytesFilter"> & {
  /**
   * @generated from oneof common.v1.BytesFilter.kind
   */
  kind: {
    /**
...
/**
 * Describes the message common.v1.BytesFilter.
